...
## MicroWebSrv is a micro HTTP Web server that supports WebSockets, html/python language templating and routing handlers, for MicroPython.

![HC²](https://raw.githubusercontent.com/jczic/MicroWebSrv/master/hc2.png)

Written in Python, available as **frozen module**.

**Ported** from [jczic/MicroWebSrv](https://github.com/jczic/MicroWebSrv) with minor changes to better work with this MicroPython port threads implementation.
