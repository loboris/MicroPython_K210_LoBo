...
if (NOT CMAKE_BUILD_TYPE)
    global_set(CMAKE_BUILD_TYPE Release)
else ()
...
if (NOT NO_BOOT_LOGGING)
    global_set(BOOT_LOGGING -DLOGGING_ENABLED)
endif ()
...
add_definitions(${BOOT_LOGGING} -DCONFIG_LOG_LEVEL=LOG_NONE -DCONFIG_LOG_ENABLE -DCONFIG_LOG_COLORS -DLOG_KERNEL -D__riscv64 -DLV_CONF_INCLUDE_SIMPLE)
